...
export default function LoginModal({ onClose, onSwitchToRegister }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 animate-[fadeInUp_0.2s_ease-out]">
        <button
          onClick={onClose}
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Sign in to access your meal plans and stats</p>
        </div>
